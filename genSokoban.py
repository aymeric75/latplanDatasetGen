...
def load_sokoban(track, num_examples, parameters=None, objects=True, **kwargs):
...
def return_sokoban(args, parameters):
    parameters["generator"] = "latplan.puzzles.sokoban"
    transitions, states = load_sokoban(**vars(args), parameters=parameters, objects=False)
    return transitions
